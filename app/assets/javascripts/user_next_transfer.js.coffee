...
$(document).on 'click', 'tr.success', (event) ->
  $('#user_next_transfer_originating_source_of_funds_id_' + $('.send_method_id', $(this)).text())
    .attr('checked', true)
  $('#user_next_transfer_destination_preference_for_funds_id_' + $('.receive_method_id', $(this)).text())
    .attr('checked', true)
